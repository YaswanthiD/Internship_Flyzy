...
a = list(map(int, input("Enter A Numbers With Spaces In First List : ").rstrip().split()))
b = list(map(int, input("Enter A Numbers With Spaces In Second List : ").rstrip().split()))
